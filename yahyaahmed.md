...
السعر قرب ل اقرب رقم 
5% بدون اصفار 




الترتيب اسم الشركه جمبها نوع التعاقد اجل ام نقدي  جمبها التخصص والباقي تحت 

الإجمالي بدون خصم هياخد من العمود L (الاجمالي بدون خصم)

قائمة الاسعار المطبقه / معدل الزياده هتضاف جنبها في نفس الصف




الاجمالي مربوط ب معدل الخصم المقترح 
...
1️⃣ أقل سعر أجل (Special Offer)
هياخد قيمة السعر من العمود O (Special Offer).

هياخد اسم الشركة من العمود P (الشركه.1).

2️⃣ قيمة التخفيض
هي الفرق بين السعر الحالي و السعر المقترح.

قيمتها بتتغير بناءً على نسبة الخصم المختاره
