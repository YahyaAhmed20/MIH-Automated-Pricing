...
patient-search/ اللينك الي ميبقاش مكتوب صح ف الشيت خليه يبقه كلمه  ميفتحش 

ف اكونت agent شيل كلا من البحث عن خدمه + متابعه الموافقات 
ف اكونت super شيل البحث عن خدمه والمرفقات ف الباكدجات الاجل 

اكونت manager شيل كلا من المرفقات ف الباكدجات الاجل + البحث عن خدمه
عايز اضيف فكره الا وهي ان الدكتور يشوف حالات دكاتره تاني وانا الي احدد يشوف مين 


اكونت Accountant شيل كلا من البحث عن خدمه + الاطباء + تفاصيل التسعير + فواتير مماثله + متابعه الباكدجات الي شامله احصائيات الباكدجات و مقارنه اداء الباكدجات + جوده البيانات + موافقه الموافقات الخارجي كلها 


agent ,super,manageer   ميشفوش ف الباكدجات الاجل المرفقات 

_______________________________________________________________



celery -A project worker --loglevel=info --pool=solo --queues=local
1. المستخدمين العاديين المشغّلين (Agent)
الصفحات المتاحة: الباكتجات – متابعة الموافقات الخارجية.

العناصر والوظائف: الباكتجات (الآجل والنقدي) – البحث عن مريض.

النطاق والاشتراطات:

النقدي: صلاحية كاملة لكافة بيانات الباكتجات النقدية.

الآجل: استعراض معلومات الباكتج فقط.
...
العناصر والوظائف: الباكتجات (الآجل والنقدي) – البحث عن مريض – متابعة الموافقات – إحصائيات الموافقات.

النطاق والاشتراطات:

النقدي: صلاحية كاملة.

الآجل: معلومات الباكتج فقط.
...
🟠 3. المدراء (Managers)
الصفحات المتاحة: الباكتجات – متابعة الموافقات الخارجية – الأطباء.

العناصر والوظائف: الباكتجات (الآجل والنقدي) – البحث عن مريض – متابعة الموافقات – إحصائيات الموافقات – قسم الأطباء.

النطاق والاشتراطات:

النقدي كله 
الاجل معلومات الباكدج فقط 
البحث عن مريض 
متابعه الموافقات 
احصائيات الموافقات 
عرض كل الاطباء 
...
🔵 4. الأطباء (Doctors)
الصفحات المتاحة: الأطباء.

العناصر والوظائف: قسم الأطباء.

النطاق والاشتراطات: كل طبيب له صلاحية استعراض الحالات الخاصة به فقط.

ملاحظات: التسجيل أو ربط الحساب عبر الـ Gmail.



🟣 5. قسم الدخول والقبول (Admission)
الصفحات المتاحة: متابعة الموافقات الخارجية.

العناصر والوظائف: متابعة الموافقات.

النطاق والاشتراطات: مخصص لاستعراض ومتابعة حالات الدخول الخاصة باليوم التالي (باكر) فقط.



🟤 6. المحاسب / الحسابات (Accountant)
الصفحات المتاحة: الباكتجات – الجهات المتعاقدة – خصومات الشركات – العروض – توصيف العمليات – قوائم الأسعار.

العناصر والوظائف: جميع البنود داخل الصفحات المحددة.

النطاق والاشتراطات: صلاحية كاملة ومطلقة على كافة البنود المالية والتسعير والتعاقدات.

🔴 7. مدير النظام (Admin)
الصفحات المتاحة: كل القوائم بلا استثناء.

العناصر والوظائف: جميع البنود والخصائص.

النطاق والاشتراطات: صلاحيات كاملة وشاملة للنظام.

ملاحظات: واجهة مستخدم خاصة ومميزة (Custom Interface).
