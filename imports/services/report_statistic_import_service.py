            ...
            try:
                ...
                if existing_stat:
                    ...
                    if existing_stat.admission_date != admission_date:
                        changes.append("admission_date")

                    if existing_stat.discharge_date != discharge_date:
                        changes.append("discharge_date")
