...
class ExternalApprovalImportService:
    ...
    def import_data(dataframe):
        ...
        deleted_count, _ = ExternalApproval.objects.all().delete()
        ...
        for idx, row in data.iterrows():
            ...
            try:
                ...
                ExternalApproval.objects.create(
                ...
                if result["created"] % 50 == 0:
                    print(f"📊 تم إنشاء {result['created']} سجل...")
                ...
                print("\n" + "=" * 80)
                print(f"❌ خطأ في صف Excel رقم: {idx + 2}")
